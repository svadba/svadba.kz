                                    ...
                                    <tr>
                                        ...
                                        @if(ServiceMan::canView())
                                            @if($adv->allow_type->id == 1)
                                                <a style="padding:0px 3px; font-size:14px" class="btn btn-info" title="Снять с публикации" href="{{url('/adverts/unallow/'.$adv->id)}}"><i class="fa fa-external-link"></i></a>
                                            @else
                                                <a style="padding:0px 3px; font-size:14px" class="btn btn-info" title="Опубликовать" href="{{url('/adverts/allow/'.$adv->id)}}"><i class="fa fa-external-link"></i></a>
                                            @endif 
                                        @endif
