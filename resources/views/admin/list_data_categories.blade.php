        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form style="margin-bottom:20px; border:1px solid gray; padding:10px;" action="{{url('admin/list_data/category/add')}}" method="POST">
                        {{ csrf_field() }}
                    ...
                    @foreach ($categories as $categ)
                        <tr>
                            ...
                            <td style="width: 172px; text-align: right;">
                                <a class="btn btn-warning" title="Редактировать город" href="{{url('admin/list_data/category/edit/'.$categ->id)}}"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-danger" title="Удалить город" href="{{url('admin/list_data/category/delete_test/'.$categ->id)}}"><i class="fa fa-trash-o"></i></a>
                            </td>
                        </tr>
                    <?php  $count++; ?>
                    @endforeach
