        ...
        <div class="">
            <div class="panel panel-default ">
                <div class="panel-heading"><h3 style="font-size:20px; margin-bottom:15px;">Объявления подрядчиков</h3>
                    ...
                    <form action="{{url('admin/adverts/my')}}" method="GET" class="search col-xs-2 col-sm-4 col-md-2">
                        <input type="search" name="search_name" placeholder="Поиск" class="input" />
                        <input type="submit" name="" value="" class="submit" />
                    </form>
                    <form action="{{url('admin/adverts/my')}}" method="GET" class="col-xs-12 col-sm-12 col-md-6">
                        {{ csrf_field() }}
