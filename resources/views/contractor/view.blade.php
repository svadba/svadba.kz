                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                ...
                                <a href="{{secure_url('admin/adverts/add/'.$contractor->id)}}" type="button" class="btn btn-primary btn-lg btn-block">+ Добавить объявление</a>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if(ServiceMan::canView())
                                                                @if($adv->allow_type->id == 1)
                                                                    <a style="" class="btn btn-primary" title="Снять с публикации" href="{{secure_url('admin/adverts/unallow/'.$adv->id)}}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                                                @else
                                                                    <a style="" class="btn btn-success" title="Опубликовать" href="{{secure_url('admin/adverts/allow/'.$adv->id)}}"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a>
                                                                @endif 
                                                            @endif
