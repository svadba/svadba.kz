                                    ...
                                    <tr>
                                        ...
                                        @if(ServiceMan::canView())
                                            @if($adv->allow_type->id == 1)
                                                <a style="padding:0px 3px; font-size:14px" class="btn btn-primary" title="Снять с публикации" href="{{url('/adverts/unallow/'.$adv->id)}}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                                            @else
                                                <a style="padding:0px 3px; font-size:14px" class="btn btn-success" title="Опубликовать" href="{{url('/adverts/allow/'.$adv->id)}}"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a>
                                            @endif 
                                        @endif
